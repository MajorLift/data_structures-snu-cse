...
public class MainSearch {
  ...
  public static void main(String args[]) throws IOException
  {
    ...
    System.out.println("Number of words in the BST: "+avl.size()
...
// ************************************************************************** //
  ...
  private static void probeBST(BST bst, String keys)
  {
    ...
    System.out.println("Height: " + bst.rootNode()height() + ", Size: " + bst.size() + ", SumFreq: " + bst.sumFreq() + ", SumAccess: " + bst.sumProbes());
    System.out.println("balancefactor: " + bst.rootNode().BalanceFactor());
